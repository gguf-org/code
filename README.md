...
2.  **Configuration**: Ensure you have a `coder.config.json` in your project root (see setup examples below, can be any OpenAI compatible API or local/self-hosted API).
