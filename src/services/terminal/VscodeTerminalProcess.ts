...
import type { ITerminalProcess, TerminalProcessEvents } from "./types"
...
export class VscodeTerminalProcess extends EventEmitter<TerminalProcessEvents> implements ITerminalProcess {
    ...
    async run(terminal: vscode.Terminal, command: string) {
        ...
        const returnCurrentTerminalContents = async () => {
            this.emit("line", "Output capture failed: Shell Integration is not available. Command was sent to terminal.");
        }
